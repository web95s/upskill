    ...
    function o(t) {
        function o(t) {
            if ("string" == typeof t && (t = document.querySelector(t)), t && "object" == typeof t && t.nodeType) {
                ...
                for (var c = n.isBorderBox = !(!h || !o[h] || "border-box" !== o[h]), p = 0, f = s.length; f > p; p++) {
                    var l = s[p],
                        d = o[l];
                    d = a(t, d);
                    var m = parseFloat(d);
                ...
                var y = n.paddingLeft + n.paddingRight,
                    ...
                    I = c && u,
                    _ = e(o.width);
                _ !== !1 && (n.width = _ + (I ? 0 : y + w));
                var L = e(o.height);
                return L !== !1 && (n.height = L + (I ? 0 : g + x)), n.innerWidth = n.width - (y + w), n.innerHeight = n.height - (g + x), n.outerWidth = n.width + v, n.outerHeight = n.height + b, n
            }
        }
...
function() {
    ...
    function(t, e) {
        ...
        s.prototype = new e, s.prototype.options = {}, s.prototype.getImages = function() {
            ...
            function t(t, n) {
                return e.options.debug && p && c.log("confirm", t, n), e.progress(t), i++, i === o && e.complete(), !0
            }
            var e = this,
                i = 0,
        ...
        function s(i, s, p, l, d, m) {
            ...
            return y.namespace = "outlayer", y.Item = m, y.defaults = {
                ...
                return Object.create ? o.prototype = Object.create(y.prototype) : e(o.prototype, y.prototype), o.prototype.constructor = o, o.defaults = e({}, y.defaults), e(o.defaults, i), o.prototype.settings = {}, o.namespace = t, o.data = y.data, o.Item = function() {
                    ...
                    for (var e = r(t), i = a.querySelectorAll(".js-" + e), n = "data-" + e + "-options", s = 0, c = i.length; c > s; s++) {
                        var p, f = i[s],
                            l = f.getAttribute(n);
                        try {
                            p = l && JSON.parse(l)
    ...
    function(t) {
        ...
        function r(t, i, r, u, c) {
            ...
            f.Item = u, f.LayoutMode = c, f.prototype._create = function() {
                ...
                for (var o = [], n = [], r = [], s = this._getFilterTest(i), a = 0, u = t.length; u > a; a++) {
                    ...
                    if (!h.isIgnored) {
                        var c = s(h);
                        c && o.push(h), c && h.isHidden ? n.push(h) : c || h.isHidden || r.push(h)
                    }
                }
                var p = this;
            ...
            f.sortDataParsers = {
                ...
                if (t) {
                    var e = [].concat.apply(t, this.sortHistory),
                        i = p(e, this.options.sortAscending);
        ...
        "function" == typeof define && define.amd ? define(["outlayer/outlayer", "get-size/get-size", "matches-selector/matches-selector", "./item", "./layout-mode", "./layout-modes/masonry", "./layout-modes/fit-rows", "./layout-modes/vertical"], r) : t.Isotope = r(t.Outlayer, t.getSize, t.matchesSelector, t.Isotope.Item, t.Isotope.LayoutMode)
    }(window),
    function(t) {
        "use strict";
    ...
    function(t) {
        ...
        "function" == typeof define && define.amd ? define(["get-size/get-size", "isotope/js/layout-mode"], e) : e(t.getSize, t.Isotope.LayoutMode)
    }(window),
    function(t) {
        "use strict";
    ...
    function(t) {
        ...
        function e(t) {
            ...
            e.prototype.reset = function() {
                ...
                for (var i = [], o = 0, n = this.spaces.length; n > o; o++) {
                    var r = this.spaces[o],
...
var hljs = new function() {
    ...
    function a(i, o, n) {
        ...
        function s(i) {
            ...
            c += "<" + e(i) + Array.prototype.map.call(i.attributes, o).join("") + ">"
        }
        ...
        for (var h = 0, c = "", p = []; i.length || o.length;) {
            var f = r();
            if (c += t(n.substr(h, f[0].offset - h)), h = f[0].offset, f == i) {
                p.reverse().forEach(a);
                do u(f.splice(0, 1)[0]), f = r(); while (f == i && f.length && f[0].offset == h);
                p.reverse().forEach(s)
            } else "start" == f[0].event ? p.push(f[0].node) : p.pop(), u(f.splice(0, 1)[0])
        }
        return c + t(n.substr(h))
    }
    ...
    function h(e, o, n, r) {
        ...
        function m() {
            ...
            var e = _.sL ? h(_.sL, S, !0, _.continuation.top) : c(S);
        ...
        function w(e, i) {
            var o = e.cN ? l(e.cN, "", !0) : "";
            e.rB ? (L += o, S = "") : e.eB ? (L += t(i) + o, S = "") : (L += o, S = i), _ = Object.create(e, {
                parent: {
                    value: _
                }
            })
        ...
        function x(e, i) {
            if (S += e, void 0 === i) return L += y(), 0;
            var o = s(i, _);
            if (o) return L += y(), w(o, i), o.rB ? 0 : i.length;
            var n = a(_, i);
            if (n) {
                var r = _;
                r.rE || r.eE || (S += i), L += y();
                do _.cN && (L += "</span>"), E += _.r, _ = _.parent; while (_ != n.parent);
                return r.eE && (L += t(i)), S = "", n.starts && w(n.starts, ""), r.rE ? 0 : i.length
            }
            if (p(i, _)) throw Error('Illegal lexeme "' + i + '" for mode "' + (_.cN || "<unnamed>") + '"');
            return S += i, i.length || 1
        }
        var I = g(e);
        if (!I) throw Error('Unknown language: "' + e + '"');
        u(I);
        for (var _ = r || I, L = "", z = _; z != I; z = z.parent) z.cN && (L = l(z.cN, L, !0));
        var S = "",
            E = 0;
        try {
            for (var R, M, C = 0;;) {
                if (_.t.lastIndex = C, R = _.t.exec(o), !R) break;
                M = x(o.substr(C, R.index - C), R[0]), C = R.index + M
            }
            x(o.substr(C));
            for (var z = _; z.parent; z = z.parent) z.cN && (L += "</span>");
            return {
                r: E,
                value: L,
                language: e,
    ...
    function f(t) {
        ...
        if ("no-highlight" != i) {
            ...
            r.value = p(r.value), t.innerHTML = r.value, t.className += " hljs " + (!i && r.language || ""), t.result = {
                language: r.language,
                re: r.r
...
hljs.registerLanguage("javascript", function(t) {
    ...
    function(t, e) {
        ...
        var p, f = document.documentElement,
            l = void 0 !== f.textContent ? "textContent" : "innerText",
            d = getStyleProperty("transition"),
            m = d ? 1e3 : 1500;
        s.notify = function(t, e) {
            i(a, t), d && (a.style[d] = "none"), a.style.display = "block", a.style.opacity = "1", e && (p && clearTimeout(p), p = setTimeout(s.hideNotify, m))
        }, s.hideNotify = function() {
            d ? (a.style[d] = "opacity 1.0s", a.style.opacity = "0") : a.style.display = "none"
